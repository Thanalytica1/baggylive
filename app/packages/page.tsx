    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-2xl font-bold text-foreground">Training Packages</h1>
            <p className="text-muted-foreground">Create and manage your custom training packages</p>
          </div>
          <AddPackageButton />
        </div>
